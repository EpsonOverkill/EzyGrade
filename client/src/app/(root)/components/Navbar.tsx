			...
			<dialog id="premium_modal" className="modal">
				<div className="modal-box">
					...
					<div className="flex items-center text-xl my-7">
						<AiFillCheckCircle className="mr-2 text-green-500" /> 100+ Multiple Uploads Support
					</div>
					<div className="flex items-center text-xl my-7">
						<AiFillCheckCircle className="mr-2 text-green-500" /> Teachers Dashboards
					</div>
					<div className="flex items-center text-xl my-7">
						<AiFillCheckCircle className="mr-2 text-green-500" /> More Valuators / Modals
					</div>
					<div className="flex items-center text-xl my-7">
						<AiFillCheckCircle className="mr-2 text-green-500" /> Mock Exams Creators
					</div>
